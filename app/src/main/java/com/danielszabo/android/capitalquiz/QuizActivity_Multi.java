...
public class QuizActivity_Multi extends AppCompatActivity {
    ...
    private SecureRandom first_random;
    private int random_my_own;
    ...
    private TextView question_number_text; // shows current question #
    private TextView current_score_text;
    private  TextView answered_boolean;
    private  TextView player_name_disp;
    ...
    private void Random_Generator() {
        first_random = new SecureRandom();
        random_my_own = first_random.nextInt(9);

    }

    private int mCurrentIndex = random_my_own;
    ...
    public static int getMax_poss_score ()
    {
        return 18;
    }
    ...
    /*  sometimes when the user answered clicked on Hint too quickly while the above button disabling-enabling was still running,
the Hint did not work correctly. This method fixes this issue */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Collections.shuffle(Arrays.asList(mAnswerBank));

        if (Done_Multi.getPlayersCompletedQuiz() == 0) {
            PlayerName = "Player 1: " + Done_Multi.getName1();
        }
        else if (Done_Multi.getPlayersCompletedQuiz() == 1) {
            PlayerName = "Player 2: " + Done_Multi.getName2(); }


        player_name_disp = (TextView) findViewById(R.id.PlayerNum);
        player_name_disp.setText(PlayerName);
        ...
        mFinishButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Done_Multi.addPlayersCompletedQuiz();

                if (Done_Multi.getPlayersCompletedQuiz() == 1) {
                    Done_Multi.setScore1(score_running);
                }
                else if  (Done_Multi.getPlayersCompletedQuiz() == 2) {
                    Done_Multi.setScore2(score_running);
                }


                Intent intent = new Intent(QuizActivity_Multi.this, Done_Multi.class);
